...
//ini_set('display_errors', '1');
  ...
  if(isset($_SESSION["suname"])){
   ...
   $sql = "SELECT LATITUDE, LONGITUDE, SPEED_KNOTS, DATE, IGNITION_STAT, Device_time FROM $tbl_name WHERE IMEI = '$timei' AND Device_time BETWEEN '$start_date' AND '$end_date'";
...
<!-- javascript for internal use-->
  ...
  <body onload="JourneyStops(ulat_coords, ulon_coords, ustrtlat, ustrtlon, ustplats, ustplons, ustoplat, ustoplon  )">
    <style>
      body {
        padding-bottom: 0px;
      }
  ...
  <div class = "row" id = "select_veh_date_NA">
    <!--Rest all comes from the code down in script-->
      ...
      <div class="row">
	    ...
	    <p>Number of Stop point(s) <a><?php echo "$stops_len"; ?></a> <img  src="http://maps.google.com/mapfiles/ms/icons/yellow-dot.png"> between start point <img src="http://maps.google.com/mapfiles/ms/icons/green-dot.png"> & end point <img src="http://maps.google.com/mapfiles/ms/icons/red-dot.png"> </p>
